...
if ($module_id && $module_class_names) {
    $opening_tag = '<' . $tag_type . ' id="' . $module_id . '" class="cards-images-hover ' . $module_class_names . '">';
} else if ($module_id && !$module_class_names) {
    $opening_tag = '<' . $tag_type . ' id="' . $module_id . '" class="cards-images-hover">';
} else if (!$module_id && $module_class_names) {
    $opening_tag = '<' . $tag_type . ' class="cards-images-hover ' . $module_class_names . '">';
} else {
    $opening_tag = '<' . $tag_type . ' class="cards-images-hover">';
}
