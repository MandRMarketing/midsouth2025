...
if ($module_id && $module_class_names) {
    $opening_tag = '<' . $tag_type . ' id="' . $module_id . '" class="cards-links ' . $module_class_names . '">';
} else if ($module_id && !$module_class_names) {
    $opening_tag = '<' . $tag_type . ' id="' . $module_id . '" class="cards-links">';
} else if (!$module_id && $module_class_names) {
    $opening_tag = '<' . $tag_type . ' class="cards-links ' . $module_class_names . '">';
} else {
    $opening_tag = '<' . $tag_type . ' class="cards-links">';
}
...
?>
    ...
    <div class="cards-container container">
        <div class="cards-grid" data-grid="grid" data-column-count="<?= $column_count ?>">
            <?php
